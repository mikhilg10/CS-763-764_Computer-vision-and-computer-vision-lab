...
##########################Added by us for BAM-RESNET######################################################3
##Channel attention Module dim = Cx1x1
...
##########################Added by us for BAM-RESNET######################################################3
#Spatial attention (conv conv) dim = 1xHxW
...
##########################Added by us for BAM-RESNET######################################################3
#BAM Module combination of the channel attention and Spatial attention
class BAM(nn.Module):
  def __init__(self,num_chan,reduction=2):
...
##########################Added by us for BAM-RESNET######################################################3
#Resnet architecture Modified with the BAM 
#BAM applied after the every layer(bock) output
#
